...
try {
    ...
    $paidStudentIds = array_column($students, 'student_id');
    $paymentModeData = [];
    if (!empty($paidStudentIds)) {
        ...
        ", array_merge($paidStudentIds, [$selectedSession]));
    }
    ...
    <div class="col-12">
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div class="mt-2">
                    <a href="paid_report.php" class="btn btn-secondary btn-sm btn-custom">
